...
const Menu = (props) => {
    ...
    return (
        <div>
            <div>
                <svg onBlur={() => {menuState(!menu)}} onClick={() => {menuState(!menu)}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
