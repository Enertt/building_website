        ...
        <div className={styles.wrapper}>
            <div className={styles.firstSection}>
                ...
                <div className={styles.textWrapper}>
                    ...
                    <div className={visibilityState.pageVisibility ? styles.pageWrapper : styles.pageWrapperNone}>
                        <span className={styles.pageTitle}>Новини компанії</span>
                        {news}
                    </div>


                    <div className={visibilityState.newsVisibility ? styles.newsCardWrapper : styles.newsCardWrapperNone}>
                        <svg onClick={() => {
                            setVisibilityState({ pageVisibility: true, newsVisibility: false })
