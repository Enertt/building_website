        ...
        <div className={styles.content}>
          ...
          <div className={styles.personDescription}>
            ...
            <div className={styles.description}>
              ...
              <br />З вересня 1980 р. по червень 1989 р. - курсант Ризького
              військового авіаційного училища ім. Якова Алксніса, по закінченні
              якого отримав диплом інженера-електрика. 3 1985 р. по 1989 р.
              служив у Далекосхідному окрузі в авіаційному полку на посаді
              інженера полку. З січня 1990 року по серпень 1992 року працював на
