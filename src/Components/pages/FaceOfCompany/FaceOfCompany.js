                    ...
                    <div className={styles.aboutCompany}>
                        ...
                        <div className={styles.sectionOne}>
                            ...
                            <div className={styles.photo}>
                                <img src={personImg} className={styles.img}/>
                            </div>
                            ...
                            <div className={styles.additional_info}>
                                <div className={styles.list}>
                                    <div className={styles.listItem}>
                                        <span className={styles.spanTitle}>РОКИ ДОСВIДУ</span><br/>
                                        <span className={styles.spanNumber}>10+</span>
                                    </div>

                                    <div className={styles.listItem}>
                                        <span className={styles.spanTitle}>ЗАВЕРШЕНІ ПРОЄКТИ</span><br/>
                                        <span className={styles.spanNumber}>45+</span>
                                    </div>

                                    <div className={styles.listItem}>
                                        <span className={styles.spanTitle}>КІЛЬКІСТЬ КЛІЄНТІВ</span><br/>
