                    ...
                    <div className={styles.ourOptions}>
                        ...
                        {/* optionList ЗАБЛЮРЕНО */}
                            <div  className={styles.optionCard}>
                                ...
                                <div className={styles.optionCard__imgBlock}>
                                    <img src={guliwer1}></img>
                                    <img src={guliwer2}></img>
                                    <img src={guliwer3}></img>
                                </div>
                                {/* <p>
...
Підземний 3-рівневий паркінг на 600 машиномісць, а також надземний паркінг на 150 машиномісць.
                            ...
                            <div  className={styles.optionCard}>
                                ...
                                <div className={styles.optionCard__imgBlock}>
                                    <img src={senator1}></img>
                                    <img src={senator3}></img>
                                    <img src={senator2}></img>
                                    <img src={senator4}></img>
                                </div>
                                {/* <p>
